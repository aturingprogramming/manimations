...
class BimatrixGames(Scene):
    ...
    # surrounding rectangle for each column
       ...
       # highlight off diagonal cells
        ...
        original_bimatrix.save_state()

        self.play(
            original_bimatrix.animate
                .scale(0.6)
        ...
        rule_box = RoundedRectangle(width=3, height=1.0)
        action_box = RoundedRectangle(width=2.2, height=1.0)
        ...
        strategy_flow.move_to(DOWN * 1.5)
